package com.example.myfirstkmmapp.translate.data.translate

import com.example.myfirstkmmapp.NetworkConstants
...
import com.example.myfirstkmmapp.translate.domain.translate.TranslateError
...
class KtorTranslateClient (
    ...
    override suspend fun translate(
        ...
        return try{ result.body<TranslatedDto>().translatedText }
        catch (e:Exception){
